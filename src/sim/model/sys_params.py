...
ROUTE_ALLOCATION = [0.35] #[0.25, 0.35, 0.45]  # [0.20] #[0.10, .20, .30] # [0.10, .20, .30]
STORE_ALLOCATION = [0.40] # [0.25, 0.35, 0.45] 
...
factors = [A_B_TESTS,STORE_ALLOCATION, TAX, ROUTE_ALLOCATION, i_wallet]
product = list(itertools.product(*factors))
A_B_TESTS,  STORE_ALLOCATION, TAX, ROUTE_ALLOCATION, i_wallet = zip(*product)
A_B_TESTS = list(A_B_TESTS)
STORE_ALLOCATION = list(STORE_ALLOCATION)
TAX = list(TAX)
ROUTE_ALLOCATION = list(ROUTE_ALLOCATION)
i_wallet = list(i_wallet)
