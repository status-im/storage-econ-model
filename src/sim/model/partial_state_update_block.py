...
partial_state_update_block = [
    ...
    # PING and UPDATE NODE Estimate AND any initialization functions
        ...
        'variables': {
            # 'network': init_node_i, REPLACED WITH init_network() at config generation
            'network': s_ping,
        }
    },
            {
    ...
    # REQUEST INITIALIZATION
        ...
        'variables': {
            ...
            # 'network': s_network_request,  Removed tokens from sender wallet ORIGINAL REQUIREMENT. NOW tokens are removed from wallet upon posting of batched proven routes.
            'event' : s_event,
        }
    },
        {
    ...
    # GRADIENT, Update gradient, Update zees, update escrow with tax and subsidy
        ...
        'variables': {
            ...
            # 'treasury': s_treasury,
            'zees' : s_zees,
            'f_hat_angles' : s_f_hat_angles,
            'f_hat' : s_f_hat,
            # 'not_f_hat_angles': s_not_f_hat_angles, 
            # 'not_f_hat' : s_not_f_hat,
        }
    },
    {
    # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
...
partial_state_update_block_B = [
    ...
    # GRADIENT, Update gradient, Update zees, update escrow with tax and subsidy
        'policies': {
          'tax_subsidy':  p_gradient_ORDER_OPS,
        },
        'variables': {
            'angles':  s_angles,
            'event' : s_reconcile,
